          ...
          <div className="mx-auto max-w-7x1 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                ...
                <span className="text-indigo-600 dak:text-indigo-500">
                  {" "}
...
focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            ...
            <div className="mt-16 max-w-2xl mx-auto flow-root sm:mt-24">
              <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                ...
                {/* <Image
                  ...
                  width={2432}
                  height={1442}
                  className="rounded-md shadow-2xl ring-1 Oring-gray-900/10"
                ></Image> */}
                <div className="relative w-full h-96 pb-75%">
                  <iframe
                    src="https://giphy.com/embed/26FPJGjhefSJuaRhu"
                    title="Giphy Embed"
